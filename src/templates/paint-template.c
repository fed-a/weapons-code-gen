class Paint_$$$CLASSNAME$$$ extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint in $$$DISPLAYNAME$$$";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"$$$MAIN_CLASS$$$");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"$$$INGREDIENT_NAME$$$");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("$$$CLASSNAME$$$");//add results here

class Paint_SN_Glock19_TDC extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint in TDC's Glock19";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SN_Glock19_Base");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SN_Glock19_TDC");//add results here

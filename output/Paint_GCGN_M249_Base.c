class Paint_maluboiii_M249 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint in Maluboi's M249";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"GCGN_M249_Base");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("maluboiii_M249");//add results here

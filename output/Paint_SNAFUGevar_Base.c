class Paint_SNAFUGevar_BNS extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint in Apocalypse MK3 Gevar";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SNAFUGevar_Base");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SNAFUGevar_BNS");//add results here
